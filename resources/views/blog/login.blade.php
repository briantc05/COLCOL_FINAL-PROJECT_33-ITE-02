	    ...
	    <nav class="navbar navbar-expand-lg navbar-dark" >
			...
			<div id="navigation" class="collapse navbar-collapse flex-column" >
				...
				<ul class="navbar-nav flex-column text-start">
					...
					<li class="nav-item">
					    <a class="nav-link" href="register"><i class="fas fa-bookmark fa-fw me-2"></i>Register</a>
					</li>
					<li class="nav-item">
    ...
    <div class="main-wrapper">
	    ...
	    <section class="cta-section theme-bg-light py-5">
		    <div class="container text-center single-col-max-width">
			    ...
			    <div class="intro">Please enter your existing account</div>

		    </div><!--//container-->
	    </section>

        <div class="single-form-max-width pt-3 mx-auto">
            <form action="/login" method="POST" class="signup-form row g-2 g-lg-2 align-items-center">
                    <label class="sr-only" for="semail"></label>
                    <input type="email" id="loginemail" name="loginemail" class="form-control me-md-1 semail" placeholder="Enter Email">
                    <input type="password" id="loginpassword" name="loginpassword" class="form-control me-md-1 semail" placeholder="Enter Password">
